    ...
    closeBttn.addEventListener('click',collapse);
        ...
        expansionButton = document.getElementById("cta-button");
            expansionButton.addEventListener('click',function(){
                // Start Frame1
                TweenMax.to('#ad', .75, {css:{top:"-602px",autoAlpha:0}, ease:Power2.easeOut}, "-=.75");
                TweenMax.to('#ad-expandable', 0.75, {css:{top:"-602px", autoAlpha:1}, ease:Power2.easeOut}, "-=.75");
                ...
                TweenMax.to('#expandable-frame1-content', 3.25, {css:{top:"0px", left:"-450px", autoAlpha:1,}, ease:Power2.easeOut, delay:3.5}, "+=4.75");
                ...
                TweenMax.to('#expandable-frame2-content', 3.25, {css:{top:"0px", left:"-450px", autoAlpha:1,}, ease:Power2.easeOut, delay:7}, "+=4.75");
