...
tl1.to('#expandable-bttn', 0.75, {css:{top:"0px", autoAlpha:1, left:"-204px"}, ease:Power2.easeOut}, "-=.75");
...
tl2.to('#expandable-content-frame1', 0.75, {css:{top:"200px", left:"0px", autoAlpha:0},delay:2.5, ease:Power2.easeOut}, "-=.75");
tl2.to('#frame2', 0.75, {css:{left:"0px", autoAlpha:1},ease:Power2.easeOut}, "-=.75");
tl2.to('#expandable-content-frame2', 0.75, {css:{top:"0px", left:"0px", autoAlpha:1},delay:0.15, ease:Power2.easeOut}, "-=.75");
tl2.to('#expandable-content-frame2', 0.75, {css:{top:"200px", left:"0px", autoAlpha:0},delay:2.5, ease:Power2.easeOut}, "-=.75");
tl2.to('#frame3', 0.75, {css:{left:"0px", autoAlpha:1},ease:Power2.easeOut}, "-=.75");
tl2.to('#expandable-content-frame3', 0.75, {css:{top:"0px", left:"0px", autoAlpha:1},delay:0.15, ease:Power2.easeOut}, "-=.75");
...
function startAd() {
    EB.initExpansionParams(0,0,300,504);
...
function expand(){
    // Start Frame1
    TweenMax.to('#ad', 0.75, {css:{width:"504"}, ease:Power2.easeOut}, "-=.75");
...
function collapse(){
    ...
    TweenMax.to('#frame1', 0.75, {css:{left:"-204px"}, ease:Power2.easeOut}, "-=.75");    
    TweenMax.to('#closeBttn', 0.75, {css:{opacity:"0"}, ease:Power2.easeOut}, "-=.75");
    TweenMax.to('#expandable-bttn', 0.75, {css:{top:"0px", autoAlpha:1, left:"-204px"}, ease:Power2.easeOut}, "-=.75");
